...
public class CreateTemporaryStayRequest {
    ...
    private java.util.UUID linkedPropertyId;
    ...
    public java.util.UUID getLinkedPropertyId() {
        return linkedPropertyId;
    }

    public void setLinkedPropertyId(java.util.UUID linkedPropertyId) {
